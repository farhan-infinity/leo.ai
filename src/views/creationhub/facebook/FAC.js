  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <FACSvg />
        <BreadCrumbs title="Facebook Ads Captions" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Facebook", link: "/facebook" }, { title: "Facebook Ads Caption", link: "/facebook_ad_caption" }]} />
      </div>
        ...
        <Row className="h-100">
          <Col lg="6" className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Facebook Ads Captions</Card.Title>
                <Card.Text>
          ...
          <Col lg="6">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              ...
              <div className="output-container h-100">
                {documentloding ? (
