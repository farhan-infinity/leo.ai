  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <YTSvg />
        <BreadCrumbs title="Youtube Video Titles" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Youtube", link: "/youtube" }, { title: "Youtube Video Title", link: "/youtube_title" }]} />
      </div>
        ...
        <Row className="h-100">
          <Col lg="6" className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Youtube Video Titles</Card.Title>
                <Card.Text>
