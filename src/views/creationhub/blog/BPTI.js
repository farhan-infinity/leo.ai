  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <BPTISvg />
        <BreadCrumbs title="Topic Ideas" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Blog", link: "/blog" }, { title: "Blog Post Topic Ideas", link: "/blog_post_topic_ideas" }]} />
      </div>
        ...
        <Row className="h-100">
          <Col lg={6} className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Blog Post Topic Ideas</Card.Title>
                <Card.Text>Brainstorm new blog post topics.</Card.Text>
              </Card.Body>
              <Card.Body>
