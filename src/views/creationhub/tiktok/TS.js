  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <TSSvg />
        <BreadCrumbs title="Tiktok Script" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Tiktok", link: "/tiktok" }, { title: "Tiktok Script", link: "/tiktok_script" }]} />
      </div>
        ...
        <Row className="h-100">
          <Col lg="6" >
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Tiktok Script</Card.Title>
                <Card.Text>
