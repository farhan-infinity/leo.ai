  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <TVTISvg />
        <BreadCrumbs title="Video Topic Idea" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Tiktok", link: "/tiktok" }, { title: "Video Topic Idea", link: "/tiktok_video_topic_idea" }]} />
      </div>
        ...
        <Row className="h-100">
          <Col lg="6" className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Tiktok Video Topic Ideas</Card.Title>
                <Card.Text>
