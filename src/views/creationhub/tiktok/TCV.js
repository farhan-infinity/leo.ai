...
const TCV = () => {
  ...
  const [index, setIndex, indexRef] = useState("15");
  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <TCVSvg />
        <BreadCrumbs title="Video Caption" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Tiktok", link: "/tiktok" }, { title: "Video Caption", link: "/tiktok_video_caption" }]} />
      </div>
      ...
      <div className="component dark-theme-component w-100">
        <Row className="h-100 inner-parent-child">
          <Col lg="6" className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Tiktok Caption for Video</Card.Title>
                <Card.Text>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-affix m-b-10">
                      <select
                        ...
                        className="react-select dark-react-select form-select form-select-lg py-2 w-100"
