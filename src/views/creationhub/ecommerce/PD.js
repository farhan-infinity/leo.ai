  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <PDSvg />
        <BreadCrumbs title="Product Description" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Ecommerce", link: "/ecommerce" }, { title: "Product Description", link: "product_description" }]} />
      </div>
          ...
          <Col lg="6" className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                ...
                <Card.Text>Create compelling product descriptions.</Card.Text>
              </Card.Body>
              <Card.Body>
