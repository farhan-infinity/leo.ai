  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <HCSvg />
        <BreadCrumbs title="Home Copy" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Ecommerce", link: "/ecommerce" }, { title: "Home Copy", link: "home_copy" }]} />
      </div>
        ...
        <Row className="h-100">
          <Col lg="6" className="h-100">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                <Card.Title>Ecommerce Home Copy</Card.Title>
                <Card.Text>
