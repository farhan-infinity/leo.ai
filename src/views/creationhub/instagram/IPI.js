  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <IPISvg />
        <BreadCrumbs title="Post Ideas" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Instagram", link: "/instagram" }, { title: "Instagram Post Idea", link: "/instagram_post_idea" }]} />
      </div>
          ...
          <Col lg="6" className="h-100 ">
            <div className="h-100 custom-card-5 dark-theme-custom-card-5">
              <Card.Body>
                ...
                <Card.Text>Generate viral posts for Instagram.</Card.Text>
              </Card.Body>
