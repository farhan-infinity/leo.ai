  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      ...
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <ICPSvg />
        <BreadCrumbs title="Caption for Post" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Instagram", link: "/instagram" }, { title: "Instagram Post Caption", link: "/instagram_post_caption" }]} />
      </div>
