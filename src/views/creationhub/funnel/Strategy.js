...
const Strategy = () => {
  ...
  const handleSubmit = (e) => {
    ...
    var postData = {
      ...
      type: "marketing_funnels_strategy",
    };
  ...
  return (
    <Container className="parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2">
      <div className="breadCrumb-custom dark-breadCrumb-custom">
        <SSvg />
        <BreadCrumbs title="Strategy" data={[{ title: "Creation Hub", link: "/creationhub" }, { title: "Marketing Funnels", link: "/funnels" }, { title: "Strategy", link: "/strategy" }]} />
      </div>
