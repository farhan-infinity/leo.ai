...
const DocumentSvg = () => {
    ...
    return (
        <>
            {skin === 'light' ? (
                <svg width="56" height="58" viewBox="0 0 68 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg width="56" height="58" viewBox="0 0 68 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect x="18" y="20" width="32" height="31" rx="6" fill="url(#paint0_linear_1744_112967)" />
                    ...
                    <defs>
                        <linearGradient id="paint0_linear_1744_112967" x1="5.0359" y1="35.5" x2="50" y2="35.5" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#1970D7" />
                            <stop offset="1" stopColor="#177FFA" />
                        </linearGradient>
                    </defs>
